...
#update Janurary 2025. keep the original resolution, filter for spatial extent as before
...
finn <- readRDS("data/all_gps_apr15_24.rds") %>% 
...
sw <- movebank_retrieve(study_id = 2235142320, sensor_type_id = "gps",   #download data for all individuals 
...
write.csv(data, file = "/home/enourani/ownCloud - enourani@ab.mpg.de@owncloud.gwdg.de/Work/Projects/HB_ontogeny_eobs/collabs/Soeren_greule_2024/original_res/honey_buzzards_ch_fn_og_res.csv",
          row.names = F)
